...
public class TestGenericLVGridExtension {
	...
	public void testHaveOverloadsOccured() {
		...
		extender = new GenericLVGridExtension();
		Bus mockBus = mock(Bus.class);
		when(mockBus.getVoltageDev()).thenReturn(1.0);
		extender.reportVoltageOverload(mockBus);
		assertTrue(extender.haveOverloadsOccured());
	}

	@Test
	public void testFindGridSectionsToExtend() {
	...
	private void testRadialCurrentOverload() {
		...
		when(slack.getBusIndex()).thenReturn(0);
		when(b1.getBusIndex()).thenReturn(1);
		when(b2.getBusIndex()).thenReturn(2);
		when(b3.getBusIndex()).thenReturn(3);
		when(b4.getBusIndex()).thenReturn(4);
		when(b5.getBusIndex()).thenReturn(5);
		when(b6.getBusIndex()).thenReturn(6);
		when(b7.getBusIndex()).thenReturn(7);
		when(b8.getBusIndex()).thenReturn(8);
		when(b9.getBusIndex()).thenReturn(9);
		when(b10.getBusIndex()).thenReturn(10);
		when(b11.getBusIndex()).thenReturn(11);
		when(b12.getBusIndex()).thenReturn(12);
		...
		when(slackb1.getLength()).thenReturn(0.06);
		when(slackb7.getLength()).thenReturn(0.06);
		when(b1b2.getLength()).thenReturn(0.06);
		when(b2b3.getLength()).thenReturn(0.06);
		when(b3b4.getLength()).thenReturn(0.06);
		when(b4b5.getLength()).thenReturn(0.06);
		when(b5b6.getLength()).thenReturn(0.06);
		when(b7b8.getLength()).thenReturn(0.06);
		when(b8b9.getLength()).thenReturn(0.06);
		when(b9b10.getLength()).thenReturn(0.06);
		when(b10b11.getLength()).thenReturn(0.06);
		when(b11b12.getLength()).thenReturn(0.06);
	...
	private void testLoopCurrentOverload() {
		...
		when(b10b11.getLength()).thenReturn(0.06);
		when(b11b12.getLength()).thenReturn(0.06);
		when(b6b12.getLength()).thenReturn(0.06);
	...
	private void testMeshedCurrentOverload() {
		...
		when(b1b8.getLength()).thenReturn(0.085);
		when(b2b9.getLength()).thenReturn(0.085);
		when(b3b10.getLength()).thenReturn(0.085);
		when(b4b11.getLength()).thenReturn(0.085);
		when(b5b12.getLength()).thenReturn(0.085);
		...
		when(b11.getConnectedPowerGridSections()).thenReturn(Arrays.asList(new GridSection[]{b10b11, b11b12, b4b11}));
